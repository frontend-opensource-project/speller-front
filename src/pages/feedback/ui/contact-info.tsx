...
export const ContactInfo = () => {
  return (
    <div className='flex gap-2 text-xs text-slate-600 tab:text-base'>
      ...
      <span className='flex items-center gap-1 leading-[0.95563rem] tracking-[-0.01375rem] tab:leading-[0.9625rem] pc:leading-[1.035rem] pc:tracking-[-0.015rem]'>
        ...
        <span>{CONTACT_INFO.tel.value}</span>
      </span>
      <span className='flex items-center gap-1 leading-[0.95563rem] tracking-[-0.01375rem] tab:leading-[0.9625rem]'>
