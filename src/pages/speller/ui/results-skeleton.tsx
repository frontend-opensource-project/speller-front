  ...
  return (
    <ContentLayout className='pb-4 tab:pb-10 pc:pb-5'>
      ...
      <div className='flex h-full flex-col gap-2 overflow-hidden pc:flex-row pc:gap-0'>
        ...
        <div className='content-visibility-auto flex min-h-[30.5rem] flex-col rounded-lg border border-blue-500 bg-white p-4 contain-strict dark:bg-dark-surface tab:rounded-[1rem] tab:p-5 pc:w-1/2 pc:rounded-bl-none pc:rounded-tl-none pc:border-none pc:p-6'>
