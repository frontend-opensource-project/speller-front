    ...
    <div className='flex items-center justify-center bg-white dark:bg-dark-surface'>
      <header className='flex flex-1 items-center justify-between p-[1rem_1.5rem] pc-lg:container tab:p-[1.25rem_3.75rem] pc:w-full pc:p-[1rem_1.875rem] pc-lg:p-[1.25rem_2rem]'>
        ...
        <div className='hidden items-center gap-4 pc:flex'>
          ...
          <a
            href='#'
            className='hidden rounded-lg border border-[#B8B8BE] p-3 font-semibold !leading-none text-slate-500 hover:bg-accent dark:border-dark-border dark:text-dark-text dark:hover:bg-dark-elevated tab:inline-flex tab:text-xl pc:text-base'
        ...
        <div className='flex items-center gap-1 pc:hidden'>
          <ThemeToggle />
        </div>
        <Popover>
          <PopoverTrigger asChild>
            <Button className='size-6 bg-icon-menu bg-[length:1.25rem] bg-center bg-no-repeat p-0 hover:bg-accent dark:brightness-0 dark:invert tab:size-7 tab:bg-[length:1.75rem] pc:hidden'>
              <span className='sr-only'>메뉴보기</span>
            </Button>
          </PopoverTrigger>
          <PopoverContent
            align='end'
            className='w-auto rounded-lg bg-slate-100 p-0 dark:bg-dark-elevated'
          >
            <ul>
              <li className='group'>
              ...
              <li className='group'>
                <Link
                  href='/guide'
                  className='flex items-center gap-2 border-b border-slate-200 px-2 py-2.5 pr-3 text-sm leading-none group-hover:text-primary dark:border-dark-border dark:text-dark-text tab:text-base'
                >
                  <i
...
const classes = {
  linkButton:
    'rounded-md p-[0.625rem_0.75rem] font-semibold !leading-none hover:bg-accent dark:text-dark-text dark:hover:bg-dark-elevated tab:inline-flex pc:text-xl',
  popoverButton:
    'flex items-center gap-2 border-b border-slate-200 px-2 py-2.5 pr-3 text-sm leading-none group-hover:text-primary dark:border-dark-border dark:text-dark-text tab:text-base',
  popoverIcon:
