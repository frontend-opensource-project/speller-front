...
const FooterInfoSection = () => {
  return (
    <div className='flex flex-col items-center gap-1 py-6 text-[0.625rem] pc:min-w-[24.0625rem] pc:items-start pc:py-0'>
      ...
      {/* 고객센터 섹션 */}
      <div className='flex gap-2 text-slate-600 dark:text-dark-text'>
      ...
      {/* 저작권 정보 */}
      <div className='text-center text-[0.625rem] font-normal leading-[0.86875rem] tracking-[-0.0125rem] text-slate-500 dark:text-dark-text tab:leading-[0.875rem] pc:text-start pc:text-[0.75rem] pc:leading-[1.035rem] pc:tracking-[-0.015rem]'>
        {/* 모바일 버전 */}
      ...
      {/* 카피라이트 */}
      <div className='text-center text-[0.625rem] font-normal leading-[1.0625rem] tracking-[-0.0125rem] text-slate-500 dark:text-dark-text tab:leading-[1.0625rem] pc:text-[0.75rem] pc:leading-[1.035rem] pc:tracking-[-0.015rem]'>
