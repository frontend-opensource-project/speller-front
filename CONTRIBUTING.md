...
type과 이슈 번호를 사용하여 새 브랜치를 만듭니다.

> 📢 `type`은 아래 <a href="#커밋-컨벤션">커밋 컨벤션</a>의 type을 참조해 주세요.
...
하나의 PR이 여러 이슈를 동시에 다루지 않도록, 이슈를 여러 개 맡은 경우에도 이슈별로 PR을 개별 생성해 주세요.
